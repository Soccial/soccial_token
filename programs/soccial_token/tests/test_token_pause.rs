// ======================================================================
// Test file: test_pause_contract.rs
// ======================================================================
...
#[tokio::test]
async fn test_pause_contract_should_succeed() -> Result<(), TransportError> {
    ...
    assert!(control.core.paused, "🚨 Contract should be paused after pause_contract call");
...
#[tokio::test]
async fn test_pause_contract_unauthorized() -> Result<(), TransportError> {
